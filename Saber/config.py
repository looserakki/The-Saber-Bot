...
def get_user_list(config, key):
    with open('{}/Saber/{}'.format(os.getcwd(), config),
              'r') as json_file:
...
class Config(object):
    ...
    TOKEN = "5027792883:AAGU4mV6DfPQmFkuNs7Z9jxhWncfmEz7ejY"  #This var used to be API_KEY but it is now TOKEN, adjust accordingly.
